...
export default function About() {
  const getData = (
    arr: (QualificationDataType | SkillDataType)[],
    title: string
  ) => {
    return arr.find(
      (item: QualificationDataType | SkillDataType) => item.title === title
    );
  };
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    ...
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      Nachdem ich lange Zeit nicht wusste, was ich nach dem Abi
                      machen soll, hab ich nun endlich gefunden was mir Spaß
                      macht. Webentwicklung!
                    </p>
                    <div className="grid xl:grid-cols-2 gap-4 mb-12 justify-center">
                      {infoData.map((item: InfoType, index: number) => {
                        return (
                          <div
                            className="flex w-full items-center gap-x-4 mx-auto xl:mx-0"
                            key={index}
                          >
